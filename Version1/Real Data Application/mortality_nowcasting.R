...
data <- readxl::read_excel("mort2021.xlsx") # Read the mortality data
...
max.delay <- 7 # Set maximum delay to seven days
...
# Do the nowcast using the Nowcasting function
my_nowcast <- Nowcasting(data = data,date.now = date.now)


############# Plot nowcast  #############

# Function to produce nowcast plot
